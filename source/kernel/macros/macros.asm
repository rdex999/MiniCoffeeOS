...
%define PIT_CHANNEL0_IRQ_PER_SEC 1000
...
%define PROCESS_DESC_REG_AX16 (PROCESS_DESC_FLAGS8 + 1)
...
%define PROCESS_DESC_REG_IP16 (PROCESS_DESC_REG_DI16 + 2)
...
%define PROCESS_DESC_SIZEOF (PROCESS_DESC_REG_CS16 + 2)
